...
const companyFilterMap: Record<string, number[]> = {
  ...
  "tag=29": [173, 12, 16, 194, 190, 20, 25, 46, 48, 116, 151, 40, 24, 114, 183, 142, 200, 334],  // 涉农类
  ...
  // tag + adv combos
  "tag=29&adv=35": [20, 46, 48, 151, 116, 194, 190, 24],
  "tag=29&adv=41": [20, 25, 46, 48, 151, 116, 194, 190, 24],
};

...
function createBeam(width: number, height: number): Beam {
  ...
  return {
    ...
    // Brand range: teal-cyan only (185-210), no purple
...
export function BeamsBackground({
  ...
  useEffect(() => {
    ...
    function resetBeam(beam: Beam, index: number, totalBeams: number) {
      ...
      // Stay in teal-cyan range — index-based for spread
      beam.hue = 185 + (index * 25) / totalBeams;
    ...
    function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
      ...
      // Underwater caustic look — teal saturated
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute inset-0 bg-deep/10"

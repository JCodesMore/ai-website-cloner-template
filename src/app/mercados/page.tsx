...
const markets = [
  ...
  { name: 'Uruguay', region: 'América del Sur', flag: '🇺🇾', detail: 'Montevideo, Punta del Este' },
  ...
  { name: 'Georgia', region: 'Europa del Este', flag: '🇬🇪', detail: 'Tiflis, Batumi' },
];
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          ...
          <p style={{ marginTop: 16, fontSize: 14, color: 'rgba(239,239,239,0.5)', maxWidth: 580 }}>
            Alianzas estratégicas con brokers y desarrolladores de prestigio en 3 continentes.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20, marginBottom: 56 }}>
          {[
            ...
            { value: '100+', label: 'Inversores asesorados' },
          ].map((stat) => (
